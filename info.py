...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5318559054').split()]
...
#stream feauter
STREAM_BIN = environ.get("STREAM_BIN", "-1001619665679") #Log channel/Bin Channel id -100xxxxxxx
